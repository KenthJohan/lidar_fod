...
static void ransac_input(v3f32 x1[], v3f32 x2[], uint8_t tags[], uint32_t xn, uint32_t n, struct fodpca * pca)
{
	uint32_t j = 0;
	...
	float lv[17] = {0.1f, 0.5f, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 4.0f, 3.0f, 2.0f, 1.0f, 0.5f, 1.0f, 0.5f, 1.0f, 0.5f, 1.0f};
	n = 17;

	for (uint32_t k = 0; k < n; ++k)
	{
		calculate_pca (pca, x2, j, 0.5f);
...
static void fodcontext_input (struct fodcontext * fod, v4f32 xyzw[CE30_WH])
{
	...
	ransac_input (fod->x1, fod->x2, fod->tags, CE30_WH, 14, &(fod->pca));
